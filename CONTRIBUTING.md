...
1. Review the [existing issues](https://github.com/playfulsparkle/oc4_product_review_feed/issues) to avoid duplicates, or open a ticket on the [support page](https://support.playfulsparkle.com/).
...
- [GitHub Issues](https://github.com/playfulsparkle/oc4_product_review_feed/issues)
